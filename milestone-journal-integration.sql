...
BEGIN
  ...
  -- Calculate consecutive days (simplified - this could be more sophisticated)
  ...
  SELECT COALESCE(MAX(streak_length), 0) INTO consecutive_days FROM consecutive_groups;
