            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-1 rounded text-sm ${
                  status.api ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                }`}>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-1 rounded text-sm ${
                  status.cloudflare ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                }`}>
                  {status.cloudflare ? "✅ Configured" : "⚠️ Using Placeholders"}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-1 rounded text-sm ${
                  status.supabase ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                }`}>
