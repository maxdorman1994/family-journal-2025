      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          {Object.entries(categoryLabels).map(([key, label]) => (
            <Badge key={key} className={`${categoryColors[key as keyof typeof categoryColors]} text-white`}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3 max-h-[500px] overflow-y-auto">
                {pins.map((pin) => (
                  <div key={pin.id} className="p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                ...
                {pins.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-xs">Click on the map to add your first adventure pin.</p>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setNewPin({ ...newPin, category: e.target.value as MapPin['category'] })}
